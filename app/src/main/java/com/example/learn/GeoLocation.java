...
public class GeoLocation extends AppCompatActivity {
    ...
    public void buscarInformacoesGPS(View v) {
        ...
        LocationManager mLocManager  = (LocationManager) getSystemService(GeoLocation.this.LOCATION_SERVICE);
        ...
        if (mLocManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            ...
            Toast.makeText(GeoLocation.this, texto, Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(GeoLocation.this, "GPS DESABILITADO.", Toast.LENGTH_LONG).show();
        }
